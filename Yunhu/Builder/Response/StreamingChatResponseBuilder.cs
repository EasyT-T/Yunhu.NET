// <copyright file="StreamingChatResponseBuilder.cs" company="ZiYueCommentary / EasyT_T">
...
public class StreamingChatResponseBuilder : IResponseBuilder<StreamingChatRequest, StreamingChatResponse>
{
    public StreamingChatResponse Build(StreamingChatRequest request, JsonElement raw)
    {
        ...
        return new StreamingChatResponse(code, msg, request, new MessageInfo(messageId, receiver));
    }
}